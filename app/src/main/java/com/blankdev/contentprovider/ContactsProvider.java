...
public class ContactsProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.blankdev.contentprovider";
    ...
    static {
        ...
        URI_MATCHER.addURI(AUTHORITY,BASE_PATH + "/#",CONTACT_ID);
    }
    ...
    public Cursor query(Uri uri, String[] strings, String s, String[] strings1, String s1) {
        ...
        switch (URI_MATCHER.match(uri)){
            case CONTACTS:
                cursor = database.query(DBOpenHelper.TABLE_CONTACTS,DBOpenHelper.ALL_COLUMNS,s,
                        null,null,null,DBOpenHelper.CONTACT_NAME + " ASC ");
                break;
            default:
